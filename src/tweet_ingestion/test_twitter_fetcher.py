...
class TestParseTweetUrl:
    """Tests for parse_tweet_url function."""
    ...
    def test_parse_www_twitter_url(self):
        """Test parsing www.twitter.com URL."""
    ...
    def test_parse_invalid_url_returns_none(self):
        ...
        assert parse_tweet_url("https://example.com") is None
        assert parse_tweet_url("not a url") is None
        assert parse_tweet_url("https://twitter.com/user") is None
